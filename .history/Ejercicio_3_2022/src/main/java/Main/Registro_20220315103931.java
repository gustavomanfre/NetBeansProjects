...
public class Registro {
    ...
    // NO APLICO BUCLE FOR EACH (MEJORADO) Y ARREGLO, POR QUE SE USA EL FOR-EACH
    // SOLO PARA LECTURA DE DATOS, NO TE PERMITE OBTENER EL INDICE
    ...
    public void registrar(Lote l) {
        ...
        //DEBERIAMOS USAR ADD, ADEMAS NO SE PUEDE RECORRER DINAMICAMENTE YA QUE AL ESTAR VACIO Y AL USAR EL INDICE NO LO ENCONTRARA YA QUE ES DINAMICO
