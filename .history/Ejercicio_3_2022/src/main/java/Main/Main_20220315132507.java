...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try { 
            ...
            FileOutputStream Fs = new FileOutputStream("Escritura");//Creamos el archivo Escritura
            ...
            Os.writeObject(e);//Transforma en un flujo de bytes ese objeto y lo guarda en el archivo apuntado por ese objeto
