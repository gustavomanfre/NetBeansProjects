...
public class Registro {
    ...
    public void registrar(Lote l) {
        ...
        //(2) ARREGLO SIMPLE - FOR EACH(MEJORADO)
        ...
        for (int i = 0;i<inmueble.size(); i++) {
            inmueble.get(i)= l;
            //POSIBLE SOLUCION AUNQUE ESTA DEMAS EL INDICE YA QUE AUTOMATICAMENTE LO POCISIONA AL FINAL TAMBIEN SOBRA EL CICLO FOR
            inmueble.add(i,l);
        }
        */

        //(4) ARRAYLIST - FOR MEJORADO
        /*NO ES POSIBLE YA QUE TAMPOCO OBTENGO EL INDICE,DEMAS NO SE PUEDE RECORRER DINAMICAMENTE YA QUE AL ESTAR VACIO Y AL USAR EL INDICE NO LO ENCONTRARA
        ES DECIR NO PUEDE RECORRERLO POR QUE ESTA VACIO Y POR ULTIMO MODIFICO LA VARIABLE ITERADORA NO EL ARREGLO YA QUE FOR MEJORADO ES SOLO DE LECTURA*/
